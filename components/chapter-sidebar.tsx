          ...
          return (
            <div key={part}>
              <button
                ...
                className="w-full flex items-center gap-2 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--sidebar-foreground)] transition-colors"
              >
                <ChevronRight

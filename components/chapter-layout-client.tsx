...
export function ChapterLayoutClient({
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex-1 min-w-0">
            {entry && (
              <div className="flex items-baseline gap-2 truncate">
                <span className="text-xs text-[var(--accent)] font-semibold tracking-wide uppercase">
                  {entry.partTitle}
                </span>
      ...
      <div className="flex">
        {/* Desktop sidebar */}
        <aside className="hidden md:block w-72 shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] bg-[var(--sidebar)] border-r border-[var(--sidebar-border)]">
